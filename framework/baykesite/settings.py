"""
Django settings for baykesite project.
...
SECRET_KEY = 'django-insecure-wrmph*u1=_74fpr6l-=&mzts$v=d3uwho#d(-e^1)o5!io-81c'
...
MIDDLEWARE = [
    ...
    'baykeshop.middleware.CreateUserInfoMiddleware'
]

ROOT_URLCONF = 'baykesite.urls'
