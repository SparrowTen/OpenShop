...
class GoodsMixin(ArticleMixin):
    """ 商品 """
    after_sale = models.TextField(_("售后服务"), blank=True, default="")
    pic = models.ImageField(_("主图"), upload_to="goods/%Y/", max_length=200)
...
class ProductMixin(BaseModelMixin):
    """ 规格 """
    pic = models.ImageField(_("主图"), upload_to="product/%Y/", max_length=200)
    ...
    item_id = models.CharField(_("商品编号"), max_length=50, blank=True, null=True, unique=True)
