...
from baykeshop.models.sites import BaykePermission, BaykeMenu, BaykeBanner
from baykeshop.models.user import BaykeUser, BaykeUserBalanceLog
from baykeshop.admin.base import BaseModelAdmin
from baykeshop.admin.base import TabularInline, StackedInline
